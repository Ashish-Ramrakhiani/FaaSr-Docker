...
# Slurm specifics - create action directory
WORKDIR /action

# Set up environment for Slurm execution
ENV SLURM_CONTAINER=true

# Default command for Slurm container execution
CMD ["Rscript", "faasr_start_invoke_slurm.R"]